    ...
    <div className="space-y-6">
      <div className="glass-panel border border-slate-200 dark:border-slate-800 rounded-3xl p-6 flex items-center justify-between">
        <div>
          <h2 className="text-lg font-black text-slate-800 dark:text-white flex items-center gap-2">
            ...
            Executive All Complaints Registry
          </h2>
          <p className="text-xs text-slate-400">Complete municipal enforcement complaints list</p>
        </div>
      ...
      <div className="glass-panel border border-slate-200 dark:border-slate-800 rounded-3xl p-6 space-y-3">
        {loading ? (
          ...
          <p className="text-center py-8 text-xs text-slate-400">No complaints registered.</p>
        ) : (
          complaints.map(item => (
